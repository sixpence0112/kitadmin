...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<%=basePath%>templates/style/benstyle/bootstrap-3.3.0/css/bootstrap.min.css">
    <link rel="stylesheet" type="text/css" href="<%=basePath%>templates/style/benstyle/fontawesome-4.2.0/css/font-awesome.min.css">
    <!--[if IE]>
    <link rel="stylesheet" type="text/css" href="<%=basePath%>templates/style/benstyle/fontawesome-4.2.0/css/font-awesome-ie7.min.css">
    <![endif]-->
    ...
    <center>
        <div style="max-width:1100px;">
            ...
            <div class="info-container">
                ...
                <ul>
                    <li>交流QQ群  <a target="_blank" href="//shang.qq.com/wpa/qunwpa?idkey=8501eea4d970827340a20ab7d51e97cb9a9f6bbf786a943ecde9638500f83be0"><b>696279396</b></a>  </li>
                    <li>
                    ...
                    <li>
                        <a href="http://study.163.com/course/courseMain.htm?courseId=1005001015&utm_campaign=commission&utm_source=cp-400000000396007&utm_medium=share" target="_blank">
                            产品在线直播课程
                        </a>
                    </li>
                </ul>
            ...
            <div class="info-container"  >
                ...
                <ul>
                    ...
                    <li>
                        ...
                        -
                        <a href="https://i.xue.taobao.com/detail.htm?spm=a2174.7365761.39b9.41.Q0W8e6&courseId=84717" target="_blank">
                            《零基础PS视频教程》
                        </a>
                        -
                        <a href="http://study.163.com/course/courseMain.htm?courseId=1005001015&utm_campaign=commission&utm_source=cp-400000000396007&utm_medium=share" target="_blank">
                        ...
                        -
                        <a href="http://study.163.com/course/introduction/1005040029.htm?utm_campaign=commission&utm_medium=share&utm_source=cp-400000000396007" target="_blank">
                            《JAVA编程实战学习班在线直播教程》
                        </a>
            ...
            <div class="info-container" style="border-bottom:none;">
                ...
                <ul>
                    ...
                    <li>后台管理静态页面：  <a href="https://gitee.com/besteasyteam/kit_admin" target="_blank"><b>kit_admin</b>（这个名字竟然奇迹般的跟我的项目一样儿一样儿的！）</a>  </li>
                    <li>富文本编辑器：  <a href="http://www.wangeditor.com/" target="_blank"><b>wangEditor&nbsp;&nbsp;V3.1.0</b></a>  </li>
