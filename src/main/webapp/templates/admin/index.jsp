...
<div class="layui-layout layui-layout-admin kit-layout-admin">
        ...
        <ul class="layui-nav layui-layout-right kit-nav">
            <li class="layui-nav-item">
                <a href="http://study.163.com/course/courseMain.htm?courseId=1005001015&utm_campaign=commission&utm_source=cp-400000000396007&utm_medium=share" target="_blank">
                    <font style="color: red">OpenKit作者免费在线直播教学</font>
                </a>
            </li>
            ...
            <ul class="layui-nav layui-nav-tree" lay-filter="kitNavbar" kit-navbar>
                ...
                <c:forEach items="${limitList}" var="limitList1" >
                    <c:if test="${limitList1.limitLeaderid==0}">
                        <li class="layui-nav-item">
                            <a class="" href="javascript:;"><i class="fa fa-plug" aria-hidden="true"></i><span> ${limitList1.limitTitle}</span></a>
    ...
    <div class="layui-footer">
        <!-- 底部固定区域 -->
        2018 &copy;
        <a href="http://admin.openkit.cc/" target="_blank">admin.openkit.cc</a> TIM OpenKit
