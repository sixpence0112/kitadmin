                    ...
                    <form class="layui-form layui-form-pane" action="">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input name="keyId" lay-verify="required" value="${kitModel.keyId}" placeholder="请输入你在阿里大鱼后台的AccessKeyId" autocomplete="off" class="layui-input" type="text">
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input name="keySecret" lay-verify="required" value="${kitModel.ketSecret}" placeholder="请输入你在阿里大鱼后台的AccessKeySecret" autocomplete="off" class="layui-input" type="password">
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input name="signName" lay-verify="required" value="${kitModel.signName}" placeholder="请输入你在阿里大鱼认证通过的短信签名" autocomplete="off" class="layui-input" type="text">
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input name="dayutemplate" lay-verify="" value="${kitModel.templateDayu}" placeholder="这里是默认短信模板，可为空，不传短信模板的时候调用这个，当然我们默认是设置验证码短信模板" autocomplete="off" class="layui-input" type="text">
                            </div>
                        </div>
                ...
                <div class="layui-tab-item">
                    <form class="layui-form layui-form-pane" action="">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input name="sid" lay-verify="required" value="${kitModel.sid}" placeholder="请输入你在云之讯的唯一标识" autocomplete="off" class="layui-input" type="text">
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input name="token" lay-verify="required" value="${kitModel.token}" placeholder="请输入你在云之讯的token" autocomplete="off" class="layui-input" type="password">
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input name="appId" lay-verify="required" value="${kitModel.appId}" placeholder="云之讯的AppId" autocomplete="off" class="layui-input" type="text">
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item">
                            <label class="layui-form-label">短信模板</label>
                            <div class="layui-input-block">
                                <input name="yzxtemplate" lay-verify="" value="${kitModel.templateYzx}" placeholder="这里是默认短信模板，可为空，不传短信模板的时候调用这个，当然我们默认是设置验证码短信模板" autocomplete="off" class="layui-input" type="text">
                            </div>
                        </div>
                ...
                <div class="layui-tab-item">
                    <form class="layui-form layui-form-pane" action="">
                        ...
                        <div class="layui-form-item">
                            <label class="layui-form-label">短信模板</label>
                            <div class="layui-input-block">
                                <input name="template" lay-verify="" placeholder="短信模板，请在各自后台读取" autocomplete="off" class="layui-input" type="text">
                            </div>
                        </div>
